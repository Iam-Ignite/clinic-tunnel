...
export default function Footer() {
    return (
      <footer className="bg-gray-900 text-white px-6 md:px-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-400 mb-6">
                Leading healthcare platform providing access to gynaecologist, booking appointments, and getting medical services online.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Book an Appointment</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Video Consultation</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Health Articles</a></li>
              </ul>
            </div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-400">
                    123 Healthcare Street, Medical Center, New York, NY 10001
                  </span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-gray-400 mr-3 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
